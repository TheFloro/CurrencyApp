...
const TabOneScreen = (props: any, navigation: RootTabScreenProps<'TabOne'>) => {
  ...
  const sortByPrice = () => {
    if (sortPrice) {
      dataToRender.sort(function (a: any, b: any) { return b.value - a.value })
      setSortPrice(false);
    } else {
      dataToRender.sort(function (a: any, b: any) { return a.value - b.value })
      setSortPrice(true);
    }
  }
  ...
  const sortByChange = () => {
    if (sortChange) {
      dataToRender.sort(function (a: any, b: any) { return b.change - a.change })
      setSortChange(false);
    } else {
      dataToRender.sort(function (a: any, b: any) { return a.change - b.change })
      setSortChange(true);
    }
  }

  // useEffect(() => {
  //   for (const [id, value] of Object.entries(thirdObject)) {
  //     array.push({ id, value })
  //   }
  //   setData(array)
  //   //console.log(data);
  ...
  // useEffect(() => {
  //   setMineData(someStore.fetchingDataByCurrency);
  //   console.log(someStore.title);
